...
if __name__ == '__main__':
    user_VPN = User(user_id='VPN').login()
    VPN_connection_A = Connection(
        client_ip='localhost',
        client_port=40000,
        local_server_ip='localhost',
        local_server_port=40002)
    VPN_connection_A.start().authenticate(user_VPN)

    VPN_connection_B = Connection(
        client_ip='localhost',
        client_port=50000,
        local_server_ip='localhost',
        local_server_port=50002)
    VPN_connection_B.start().authenticate(user_VPN)
